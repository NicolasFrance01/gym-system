      ...
      <div className="relative z-10 flex h-screen overflow-hidden">
        ...
        <aside className="w-64 border-r border-white/5 bg-black/20 backdrop-blur-2xl flex flex-col p-6">
          ...
          <nav className="space-y-2 flex-1">
            ...
            <SidebarItem icon={<Users size={20} />} label="Members" />
            <SidebarItem icon={<CreditCard size={20} />} label="Finance" />
            <SidebarItem icon={<TrendingUp size={20} />} label="AI Analytics" />
          </nav>
        ...
        <main className="flex-1 overflow-y-auto p-10 bg-black/10">
          <header className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl font-bold tracking-tight text-white mb-2">Welcome Back, Admin</h2>
              <p className="text-white/40">Here's what's happening at Gym-Atlas today.</p>
            </div>
