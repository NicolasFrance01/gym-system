...
export default function KioskView() {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a] text-white overflow-hidden font-sans selection:bg-orange-500/30">
      ...
      <div className="flex-1 flex flex-col z-0 relative bg-[#0a0a0a]">
      ...
      {window.location.protocol === 'https:' && !window.location.hostname.includes('127.0.0.1') && !window.location.hostname.includes('localhost') && (
        <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-xl flex items-center justify-center p-8">
          <div className="max-w-md w-full bg-[#0a0a0a] border border-red-500/30 rounded-[40px] p-10 text-center shadow-2xl">
            ...
            <button 
              ...
              className="w-full py-4 bg-[#F38E26] text-white border border-[#F38E26] font-bold rounded-2xl hover:scale-[1.02] transition-all"
            >
              Ir al Kiosko Local
            </button>
          </div>
