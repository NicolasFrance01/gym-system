...
const agendaStart = testCode.indexOf('function AgendaModule(');
const agendaEnd = testCode.indexOf('export default function AdminDashboard');
const agendaModule = testCode.substring(agendaStart, agendaEnd);
